...
<body onload="submitPayuForm()">
    <div class="content">
        ...
        <div class="form">
            <form action="<?php echo $action; ?>" method="POST" name="payuForm" id="reportForm">
                ...
                <input type="hidden" name="phone" value="8473825675" />
  ...
  <li>
    <input class="styled-checkbox" id="styled-checkbox-3" type="checkbox" value="yes" name="chkUrea">
    <label for="styled-checkbox-3">Blood Urea</label>
  </li>
  <li>
    <input class="styled-checkbox" id="styled-checkbox-3" type="checkbox" value="yes" name="chkUric">
    <label for="styled-checkbox-3">Uric Acid</label>
  </li>
  <li>
    <input class="styled-checkbox" id="styled-checkbox-3" type="checkbox" value="yes" name="chkCrea">
    <label for="styled-checkbox-3">Creatinine</label>
  </li>
  <li>
    <input class="styled-checkbox" id="styled-checkbox-3" type="checkbox" value="yes" name="chkAmyl">
    <label for="styled-checkbox-3">Amylase</label>
  </li>
  <li>
    <input class="styled-checkbox" id="styled-checkbox-3" type="checkbox" value="yes" name="chkLipa">
    <label for="styled-checkbox-3">Lipase</label>
  </li>
  <li>
    <input class="styled-checkbox" id="styled-checkbox-3" type="checkbox" value="yes" name="chkSgot">
    <label for="styled-checkbox-3">SGOT</label>
  </li>
  <li>
    <input class="styled-checkbox" id="styled-checkbox-3" type="checkbox" value="yes" name="chkSgpt">
    <label for="styled-checkbox-3">SGPT</label>
                ...
                <br>
                <label>Fasting</label>
                <input type="number" step="any" min="0" placeholder="Blood Fasting" name="fs" value="<?php echo $fs; ?>"/>
                <br>
                <label>Random</label>
                <input type="number" step="any" min="0" placeholder="Blood Random" name="ran" value="<?php echo $ran; ?>"/>
                <br>
                ...
                <input type="number" step="any" min="0" placeholder="Blood Urea" name="urea" value="<?php echo $urea; ?>"/>
                <br>
                <label>Uric Acid</label>
                <input type="number" step="any" min="0" placeholder="Uric Acid" name="uric" value="<?php echo $uric; ?>"/>
                <br>
                <label>Creatinine</label>
                <input type="number" step="any" min="0" placeholder="Creatinine" name="crea" value="<?php echo $crea; ?>"/>
                <br>
                <label>Amylase</label>
                <input type="number" step="any" min="0" placeholder="Amylase" name="amyl" value="<?php echo $amyl; ?>"/>
                <br>
                <label>Lipase</label>
                <input type="number" step="any" min="0" placeholder="Lipase" name="lipa" value="<?php echo $lipa; ?>"/>
                <br>
                <label>Sgot</label>
                <input type="number" step="any" min="0" placeholder="Enter SGOT" value="<?php echo $sgot; ?>" name="sgot" />
                <br>
                <label>Sgpt</label>
                <input type="number" step="any" min="0" placeholder="Enter SGPT" value="<?php echo $sgpt; ?>" name="sgpt" />
                <br>
