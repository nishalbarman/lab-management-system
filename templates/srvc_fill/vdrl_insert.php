...
if (isset($_POST['create'])) {
    ...
    $return_url1 = "vdrl.php?serial=".$serial."&patient_sample=".$sample."&report_date=".$date."&dr_name=".$reffered."&patient_name=".$name;
    $return_url2 = "&patient_age=".$age."&patient_gender=".$gender;
    $return_url3 = "&na=".$na."&k=".$k."&ca=".$ca;
...
<body onload="submitPayuForm()">
    <div class="content">
        <center>
            <br>
            <h class="header">Serum Electrolyte<label>
        </center>
        <div class="form">
            <form action="<?php echo $action; ?>" method="POST" name="payuForm" id="reportForm">
                ...
                <label>HIV</label>
                <input type="text" step="any" min="0" placeholder="HIV" name="na" />
                <br>
                <label>BLOOD VDRL</label>
                <input type="text" step="any" min="0" placeholder="BLOOD VDRL" name="k" />
                <br>
                <label>HBsAg (Australia Antigen)</label>
                <input type="text" step="any" min="0" placeholder="HBsAg (Australia Antigen)" name="ca" />
                <br>
