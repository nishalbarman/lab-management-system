    ...
    <div class="content">
        ...
        <div class="form">
            <form action="<?php echo $action; ?>" method="POST" name="payuForm" id="reportForm">
                ...
                <input type="number" step="any" min="0" placeholder="Enter Platelet" value="<?php echo $plc; ?>" name="plc" />
                <br>
                <label>RBC count:</label>
                <input type="number" step="any" min="0" placeholder="Enter RBC" value="<?php echo $rbc; ?>" name="rbc" />
                <br>
                <label>PCV:</label>
                <input type="number" step="any" min="0" placeholder="Enter PCB" value="<?php echo $pcv; ?>" name="pcv" />
                <br>
                <label>MCV:</label>
                <input type="number" step="any" min="0" placeholder="Enter MCV" value="<?php echo $mcv; ?>" name="mcv" />
                <br>
                <label>MCH:</label>
                <input type="number" step="any" min="0" placeholder="Enter MCH" value="<?php echo $mch; ?>" name="mch" />
                <br>
                <label>MCHC:</label>
                <input type="number" step="any" min="0" placeholder="Enter MCHC" value="<?php echo $mchc; ?>" name="mchc" />
                <br>
                <label>RDW-CV:</label>
                <input type="number" step="any" min="0" placeholder="Enter RDW-CV" value="<?php echo $rdw; ?>" name="rdw" />
                <br>
