...
if (isset($_POST['create'])) {
  ...
  $return_url1 = "abs.php?serial=" . $serial . "&patient_sample=" . $sample . "&report_date=" . $date . "&dr_name=" . $reffered . "&patient_name=" . $name;
  $return_url2 = "&patient_age=" . $age . "&patient_gender=" . $gender;
  $return_url3 = "&eos=" . $abs_eo . "&neo=" . $abs_ne;
...
<body onload="submitPayuForm()">
  <div class="content">
    <center>
      <br>
      <h class="header">Abs Report<label>
    </center>
    <div class="form">
      <form action="<?php echo $action; ?>" method="POST" name="payuForm" id="reportForm">
        ...
        <input type="hidden" name="report_name" value="<?php echo $reportname; ?>" />
        ...
        <label>Abs. EOSINOPHIL COUNT</label>
        <input type="number" step="any" min="0" placeholder="Abs. EOSINOPHIL COUNT" name="abs_eo"
          value="<?php echo $abs_eo; ?>" />
        <br>
        <label>Abs. Abs. NEUTROPHIL COUNT</label>
        <input type="number" step="any" min="0" placeholder="Abs. NEUTROPHIL COUNT" name="abs_ne"
          value="<?php echo $abs_ne; ?>" />
        <br>
        ...
        <button type="button" class="button" data-toggle="modal" data-target="#exampleModalCenter" style="display:none"
