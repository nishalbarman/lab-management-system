...
if (isset($_POST['create'])) {
    ...
    $return_url1 = "electro.php?serial=".$serial."&patient_sample=".$sample."&report_date=".$date."&dr_name=".$reffered."&patient_name=".$name;
    ...
    <div class="content">
        ...
        <div class="form">
            <form action="<?php echo $action; ?>" method="POST" name="payuForm" id="reportForm">
                ...
                <input type="number" step="any" min="0" placeholder="Sodium (Na+)" name="na" />
                <br>
                <label>Ptassium (K+)</label>
                <input type="number" step="any" min="0" placeholder="Ptassium (K+)" name="k" />
                <br>
                <label>Calcium (Ca+)</label>
                <input type="number" step="any" min="0" placeholder="Calcium (Ca+)" name="ca" />
                <br>
