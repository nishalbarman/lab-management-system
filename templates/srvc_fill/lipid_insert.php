...
if (isset($_POST['create'])) {
    ...
    $return_url1 = "lipidpro.php?serial=" . $serial . "&patient_sample=" . $sample . "&report_date=" . $date . "&dr_name=" . $reffered . "&patient_name=" . $name;
    ...
    <div class="content">
        ...
        <div class="form">
            <form action="<?php echo $action; ?>" method="POST" name="payuForm" id="reportForm">
                ...
                <input type="number" step="any" min="0" placeholder="Enter Cholestrol" value="<?php echo $tlc; ?>"
                    name="tlc" />
                <br>
                <label>Trigli :</label>
                <input type="number" step="any" min="0" placeholder="EnterTrygli value=" <?php echo $neu; ?>" name="neu"
                />
                <br>
