...
<!---------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="height:32px; vertical-align:top; width:199px">
                <p style="text-align:center"><span style="font-size:13pt">/cumm</span>
                </p>
            </td>
            <td style="height:32px; vertical-align:top; width:170px">
                <p style="text-align:center"><span style="font-size:13pt">4000-11000</span>
                </p>
            </td>
        </tr>
        <tr>
            <td style="height:30px; vertical-align:top; width:88px">
                <p><span style="font-size:13pt">DLC
                                :</span></p>

                <p style="text-align:right">&nbsp;</p>
            </td>
            <td style="height:30px; vertical-align:top; width:89px">
                <p style="text-align:right"><span style="font-size:13pt">Neutrophil
                                :</span></p>

                <p style="text-align:right"><span style="font-size:14pt">Lymphocyte:</span>
                </p>

                <p style="text-align:right"><span style="font-size:13pt">Monocyte
                                :</span></p>

                <p style="text-align:right"><span style="font-size:13pt">Eosinophil
                                :</span></p>

                <p style="text-align:right"><span style="font-size:13pt">Basophil
                                :</span></p>
            </td>
            <td style="height:30px; vertical-align:top; width:152px">
                <p style="text-align:center"><span style="font-size:13pt"><?php echo $_GET['neu']; ?></span>
                </p>

                <p style="text-align:center"><span style="font-size:13pt"><?php echo $_GET['lym']; ?></span>
                </p>

                <p style="text-align:center"><span style="font-size:13pt"><?php echo $_GET['mono']; ?></span>
                </p>

                <p style="text-align:center"><span style="font-size:13pt"><?php echo $_GET['eos']; ?></span>
                </p>

                <p style="text-align:center"><span style="font-size:13pt"><?php echo $_GET['bas']; ?></span>
                </p>
            ...
            <td style="height:30px; vertical-align:top; width:199px">
                <p style="text-align:center"><span style="font-size:13pt">%</span>
                </p>

                <p style="text-align:center"><span style="font-size:13pt">%</span></span>
                </p>
                ...
                <p style="text-align:center"><span style="font-size:13pt">%</span><br />
                    &nbsp;</p>
            </td>
            <td style="height:30px; vertical-align:top; width:170px">
                <p style="text-align:center"><span style="font-size:13pt">40-70%</span>
                </p>

                <p style="text-align:center"><span style="font-size:13pt">20-40%</span>
                </p>

                <p style="text-align:center"><span style="font-size:13pt">02-10%</span>
                </p>

                <p style="text-align:center"><span style="font-size:13pt">01-06%</span>
                </p>
        ...
        <tr>
            <td colspan="2" style="height:30px; vertical-align:top; width:177px">
                <p><span style="font-size:13pt">Hb%
                                :</span></p>
            </td>
            <td style="height:30px; vertical-align:top; width:152px">
            ...
            <td style="height:30px; vertical-align:top; width:199px">
                <p style="text-align:center"><span style="font-size:13pt">gm/dl</span>
                </p>
            </td>
            <td style="height:30px; vertical-align:top; width:170px">
                <p style="text-align:center"><span style="font-size:13pt">M(13-17),
                                F(12-15)</span></p>
            </td>
        </tr>
        <tr>
            <td colspan="2" style="height:30px; vertical-align:top; width:177px">
                <p><span style="font-size:13pt">Platelet Count
                                :</span></p>
            </td>
            <td style="height:30px; vertical-align:top; width:152px">
                <p style="text-align:center"><span style="font-size:13pt">
            ...
            <td style="height:30px; vertical-align:top; width:199px">
                <p style="text-align:center"><span style="font-size:13pt">Thousand/cumm</span>
                </p>
            </td>
            <td style="height:30px; vertical-align:top; width:170px">
                <p style="text-align:center"><span style="font-size:13pt">150-410</span>
                </p>
            </td>
        </tr>
        <tr>
            <td colspan="2" style="height:30px; vertical-align:top; width:177px">
                <p><span style="font-size:13pt">RBC Count
                                :</span></p>
            </td>
            <td style="height:30px; vertical-align:top; width:152px">
                <p style="text-align:center"><span style="font-size:13pt">
            ...
            <td style="height:30px; vertical-align:top; width:199px">
                <p style="text-align:center"><span style="font-size:13pt">mil/cmm</span>
                </p>
            </td>
            <td style="height:30px; vertical-align:top; width:170px">
                <p style="text-align:center"><span style="font-size:13pt">M(4.5-5.5),
                                F(3.8-4.8)</span></p>
            </td>
        </tr>
        <tr>
            <td colspan="2" style="height:30px; vertical-align:top; width:177px">
                <p><span style="font-size:13pt">PCV
                                :</span></p>
            </td>
            <td style="height:30px; vertical-align:top; width:152px">
                <p style="text-align:center"><span style="font-size:13pt">
            ...
            <td style="height:30px; vertical-align:top; width:170px">
                <p style="text-align:center"><span style="font-size:13pt">M(40-50),
                                F(36-46)</span></p>
            </td>
        </tr>
        <tr>
            <td colspan="2" style="height:30px; vertical-align:top; width:177px">
                <p><span style="font-size:13pt">MCV
                                    :</span></p>
            </td>
            <td style="height:30px; vertical-align:top; width:152px">
                <p style="text-align:center"><span style="font-size:13pt">
            ...
            <td style="height:30px; vertical-align:top; width:199px">
                <p style="text-align:center"><span style="font-size:13pt">cu
                                micron</span></p>
            </td>
            <td style="height:30px; vertical-align:top; width:170px">
                <p style="text-align:center"><span style="font-size:13pt">92 +/-
                                9</span></p>
            </td>
        </tr>
        <tr>
            <td colspan="2" style="height:30px; vertical-align:top; width:177px">
                <p><span style="font-size:13pt">MCH
                                :</span></p>
            </td>
            <td style="height:30px; vertical-align:top; width:152px">
                <p style="text-align:center"><span style="font-size:13pt">
            ...
            <td style="height:30px; vertical-align:top; width:199px">
                <p style="text-align:center"><span style="font-size:13pt">picograms</span>
                </p>
            </td>
            <td style="height:30px; vertical-align:top; width:170px">
                <p style="text-align:center"><span style="font-size:13pt">29.5 +/-
                                2.5</span></p>
            </td>
        </tr>
        <tr>
            <td colspan="2" style="height:30px; vertical-align:top; width:177px">
                <p><span style="font-size:13pt">MCHC
                                :</span></p>
            </td>
            <td style="height:30px; vertical-align:top; width:152px">
                <p style="text-align:center"><span style="font-size:13pt">
            ...
            <td style="height:30px; vertical-align:top; width:199px">
                <p style="text-align:center"><span style="font-size:13pt">g/dl</span>
                </p>
            </td>
            <td style="height:30px; vertical-align:top; width:170px">
                <p style="text-align:center"><span style="font-size:13pt">33 +/-
                                1.5</span></p>
            </td>
        </tr>
        <tr>
            <td colspan="2" style="height:30px; vertical-align:top; width:177px">
                <p><span style="font-size:13pt">RDW-CV
                                :</span></p>
            </td>
            <td style="height:30px; vertical-align:top; width:152px">
                <p style="text-align:center"><span style="font-size:13pt">
            ...
            <td style="height:30px; vertical-align:top; width:170px">
                <p style="text-align:center"><span style="font-size:14pt">11.6-14.6</span></p>
            </td>
        </tr>
    </tbody>
</table>
