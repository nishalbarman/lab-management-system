...
<table align="center" cellspacing="0" class="ReportTable" style="border-collapse:collapse; border:none;">
	<tbody>
		...
		<tr id="sodium">
			...
			<p style="text-align:left; vertical-align: middle;"><span style="font-size:13pt">H.I.V. Test</span></p>
			</td>
			<td style="height:30px; vertical-align:top; width: 20%">
			<p style="text-align:center"><span style="font-size:13pt"><?php echo $_GET['na']; ?></span></p>
			</td>
			<td style="height:30px; vertical-align:top; width: 20%">
        ...
        <tr id="potassium">
			<td style="height:30px; vertical-align:top; width: 20%">
			<p style="text-align:left; vertical-align: middle;"><span style="font-size:13pt">BLOOD VDRL</span></p>
			</td>
			<td style="height:30px; vertical-align:top; width: 20%">
			<p style="text-align:center"><span style="font-size:13pt"><?php echo $_GET['k']; ?></span></p>
			</td>
			<td style="height:30px; vertical-align:top; width: 20%">
			<p style="text-align:center"><span style="font-size:13pt"></span></span></p>
			</td>
        ...
        <tr id="calcium">
			<td style="height:30px; vertical-align:top; width: 20%">
			<p style="text-align:left; vertical-align: middle;"><span style="font-size:13pt">HBsAg(Australia antigen)</span></p>
			</td>
			<td style="height:30px; vertical-align:top; width: 20%">
			<p style="text-align:center"><span style="font-size:13pt"><?php echo $_GET['ca']; ?></span></p>
			</td>
			<td style="height:30px; vertical-align:top; width: 20%">
			<p style="text-align:center"><span style="font-size:13pt"></span></span></p>
			</td>
