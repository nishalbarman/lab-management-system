...
<!---------------------------------------------------------------------------------------------------------------------------------------------- -->
<table align="center" cellspacing="0" class="PatientTable" style="border-collapse:collapse; border:none;">
	<tbody>
		<tr>
		...
		<tr>
			...
			<p style="text-align:center"><span style="font-size:13pt">HAEMOGLOBIN</span></p>
			</td>
			<td style="height:30px; vertical-align:top; width: 20%">
			<p style="text-align:center"><span style="font-size:13pt"><?php echo $_GET['fs']; ?></span></p>
			</td>
			<td style="height:30px; vertical-align:top; width: 20%">
			<p style="text-align:center"><span style="font-size:13pt">gm/dl</span></span></p>
			</td>
			<td style="height:30px; vertical-align:top; width: 25%">
			<p style="text-align:center"><span style="font-size:13pt">M(13-17), F(12-15)</span></p>
			</td>
		</tr>
	</tbody>
</table>
