...
<table align="center" cellspacing="0" class="ReportTable"
    ...
    <tr >
        ...
        <tr id="fasting" style="height: 5px;"/>
        <tr id="pap" >
            <td colspan="2" style="height:30px; vertical-align:center; width:177px">
		...
		<tr id="amylase" >
            <td colspan="2" style="height:30px; vertical-align:center; width:177px">
                <p><span style="font-size:13.5pt">AMYLASE</span></p>
            </td>
            <td style="height:30px; vertical-align:center; width:152px">
                <p style="text-align:center"><span style="font-size:13.5pt">
                                <?php echo $_GET['amyle'];?> U/L
                            </span></p>
            </td>
            
            <td style="height:30px; vertical-align:; width:170px">
                <p style="text-align:center"><span style="font-size:13.5pt">( < 90 ) U/L</span>
                </p>
            </td>
            ...
            <td style="height:30px; vertical-align:top; width:20%">
                <p style="text-align:center"><span style="font-size:11pt"><span
                            style="font-family:Calibri,sans-serif"><span
                                style="font-family:&quot;Bahnschrift SemiBold&quot;,sans-serif">CNPG3</span></span></span>
                </p>
            </td>
        </tr>
		...
		<tr id="lipase" >
            <td colspan="2" style="height:30px; vertical-align:center; width:177px">
                <p><span style="font-size:13.5pt">&nbsp;LIPASE</span></p>
            </td>
            <td style="height:30px; vertical-align:center; width:152px">
                <p style="text-align:center"><span style="font-size:13.5pt">
                                <?php echo $_GET['lipa'];?> U/L
                            </span></p>
            </td>
            
            <td style="height:30px; vertical-align:; width:170px">
                <p style="text-align:center"><span style="font-size:13.5pt">( < 60 ) U/L</span>
                </p>
            </td>
        ...
        <tr id="sgot" >
            <td colspan="2" style="height:30px; vertical-align:center; width:177px">
                <p><span style="font-size:13.5pt">&nbsp;SGOT</span></p>
            </td>
            <td style="height:30px; vertical-align:center; width:152px">
                <p style="text-align:center"><span style="font-size:13.5pt">
                                <?php echo $_GET['sgot'];?> U/L
                            </span></p>
            </td>
            
            <td style="height:30px; vertical-align:; width:170px">
                <p style="text-align:center"><span style="font-size:13.5pt">(8-40) U/L</span>
                </p>
            </td>
        ...
        <tr id="sgot" style="height: 5px;"/>
		<tr id="sgpt" >
            <td colspan="2" style="height:30px; vertical-align:center; width:177px">
                <p><span style="font-size:13.5pt">&nbsp;SGPT</span></p>
            </td>
            <td style="height:30px; vertical-align:center; width:152px">
                <p style="text-align:center"><span style="font-size:13.5pt">
                                <?php echo $_GET['sgpt'];?> U/L
                            </span></p>
            </td>
            
            <td style="height:30px; vertical-align:; width:170px">
                <p style="text-align:center"><span style="font-size:13.5pt">(5-35) U/L</span>
                </p>
            </td>
