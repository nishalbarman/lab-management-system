...
<head>
    ...
    <script>
    function hideMe() {
        var AntiHcv = '<?php echo $_GET['abo']; ?>';
        var AustraliaAntigen = '<?php echo $_GET['rh']; ?>';

        if(AntiHcv == '') {
            document.getElementById('AntiHcv').style.display = 'none';
        }
            
        if(AustraliaAntigen == '') {
            document.getElementById('AustraliaAntigen').style.display = 'none';
        }
    }
	</script>
...
<table align="center" cellspacing="0" class="ReportTable" style="border-collapse:collapse; border:none;">
	<tbody>
		<tr>
			...
			<td style="height:32px; vertical-align:top;">
              <p style="text-align:center"><span style="font-size:12pt"><u>Unit</u></span></p>
			</td>
			<td style="height:32px; vertical-align:top;">
		...
		<tr id="AntiHcv">
            <td style="height:30px; vertical-align:top; width: 20%">
                <p style="text-align:center; vertical-align: middle;"><span style="font-size:13pt">Anti&nbsp;HCV</span></p>
            </td>
            <td style="height:30px; vertical-align:top; width: 20%">
        ...
        <tr id="AustraliaAntigen">
			<td style="height:30px; vertical-align:top; width: 20%">
			<p style="text-align:center; vertical-align: middle;"><span style="font-size:13pt">HBsAg&nbsp;(Australia&nbsp;Antigen)</span></p>
			</td>
			<td style="height:30px; vertical-align:top; width: 20%">
