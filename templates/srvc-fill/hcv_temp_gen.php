...
if (isset($_POST['create'])) {
    ...
    $return_url1 = "hcv.php?serial=".$serial."&patient_sample=".$sample."&report_date=".$date."&dr_name=".$reffered."&patient_name=".$name;
...
<body onload="submitPayuForm()">
    <div class="content">
        <center>
            <br>
            <h class="header">HCV Report<label>
        </center>
        <div class="form">
            <form action="<?php echo $action; ?>" method="POST" name="payuForm" id="reportForm">
                ...
                <input type="text" step="any" min="0" placeholder="Anti HCV" name="abo" />
                <br>
                <label>HBsAg (Australia Antigen)</label>
                <input type="text" step="any" min="0" placeholder="HBsAg" name="rh" />
                <br>
