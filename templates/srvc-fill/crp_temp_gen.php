...
if (isset($_POST['create'])) {
    ...
    $return_url1 = "crp.php?serial=" . $serial . "&patient_sample=" . $sample . "&report_date=" . $date . "&dr_name=" . $reffered . "&patient_name=" . $name;
...
<head>
    <title>HealthKind Template CRP</title>
...
<body>
    ...
    <div class="lets-do">
        <center>
            <br>
            <h class="header">CRP TEST Report<label>
        </center>
        <div class="form">
            <form action="<?php echo $action; ?>" method="POST" name="payuForm" id="reportForm">
                ...
                <input type="number" step="any" min="0" placeholder="Enter CRP" name="fs" />
                <br>
