...
if (isset($_POST['create'])) {
  ...
  $return_url1 = "haemoglobin.php?serial=" . $serial . "&patient_sample=" . $sample . "&report_date=" . $date . "&dr_name=" . $reffered . "&patient_name=" . $name;
...
<body>
    ...
    <div class="lets-do">
        <center>
            <br>
            <h class="header">Haemoglobin Report<label>
        </center>
        <div class="form">
            <form action="<?php echo $action; ?>" method="POST" name="payuForm" id="reportForm">
                ...
                <br>
                <label>Haemooglobin</label>
                <input type="number" step="any" min="0" placeholder="Enter Value" name="fs" />
                <br>
