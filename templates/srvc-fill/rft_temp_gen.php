...
if (isset($_POST['create'])) {
    ...
    $return_url1 = "rft.php?serial=".$serial."&patient_sample=".$sample."&report_date=".$date."&dr_name=".$reffered."&patient_name=".$name;
    $return_url2 = "&patient_age=".$age."&patient_gender=".$gender."&urea=".$urea."&uric=".$uric;
    $return_url3 = "&crea=".$crea."&amyle=".$amyl."&lipa=".$lipa;
    // ."&chkUrea=".$chkUrea;
    $return_url4 = "&create=Submit";
    // "&chkUric=".$chkUric."&chkCrea=".$chkCrea."&chkAmyl=".$chkAmyl."&chkLipa=".$chkLipa."&create=Submit";
...
<body onload="submitPayuForm()">
    <div class="content">
        <center>
            <br>
            <h class="header">RFT Reports<label>
        </center>
        <div class="form">
            <form action="<?php echo $action; ?>" method="POST" name="payuForm" id="reportForm">
                ...
                <br>
                <h3 style="display: none;">Check the requirements</h3>
                <ul style="display: none;" class="unstyled centered">
  <li>
  ...
  <li>
    ...
    <label for="styled-checkbox-3">Ptassium</label>
                ...
                <br>
                <label>Sodium</label>
                <input type="number" step="any" min="0" placeholder="Sodium" name="amyl" />
                <br>
                <label>Ptassium</label>
                <input type="number" step="any" min="0" placeholder="Ptassium" name="lipa" />
                <br>
