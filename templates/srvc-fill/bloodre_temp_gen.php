...
<body onload="submitPayuForm()">
    <div class="content">
        <center>
            <h class="header">RE Report<label>
        </center>
        <div class="form">
            <form action="<?php echo $action; ?>" method="POST" name="payuForm" id="reportForm">
                ...
                <input type="number" step="any" min="0" placeholder="Enter Neutrophil" value="<?php echo $neu; ?>" name="neu" />
                <br>
                <label>Lymphocyte :</label>
                <input type="text" step="any" min="0" placeholder="Enter Lymphocyte" value="<?php echo $lym; ?>" name="lym" />
                <br>
                <label>Monocyte :</label>
                <input type="number" step="any" min="0" placeholder="Enter Monocyte" value="<?php echo $mono; ?>" name="mono" />
                <br>
                <label>Eosinophil:</label>
                <input type="number" step="any" min="0" placeholder="Enter Eosinophil" value="<?php echo $eos; ?>" name="eos" />
                <br>
                ...
                <br>
                <label>ESR:</label>
                <input type="number" step="any" min="0" placeholder="Enter Platelet" value="<?php echo $esr; ?>" name="esr" />
                <br>
