...
<body>
    ...
    <p class="headBtn">
        ...
        <div class="login">
            <form action="custom-update-report.php" method="post" enctype="multipart/form-data">
                <label>Update Report for </label>
                <label>
                    <?php echo $_GET['file']; ?>
                </label><br><br>
                <input class="file_up" type="file" name="thefile">
                <input type="hidden" value="<?php echo $_GET['file']; ?>" name="thefilename" /> <br>
